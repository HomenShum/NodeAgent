...
const targets: GuidanceTarget[] = [
  ...
  { path: "examples/apps/chat-ui/README.md", required: [...appSections, "## Runtime Mapping", "## App Tools To Add", "## Coding-Agent Prompt", "npm run nodeagent -- apps scaffold chat-ui", "--auto"] },
  { path: "examples/apps/chat-ui/template/README.md", required: ["# NodeAgent Chat UI", "## No API Keys", "## Spin Up", "## Chat Runtime", "npm run agent:demo", "setup-receipt.json"] },
...
const supportFiles = [
  ...
  "examples/apps/chat-ui/template/.env.example",
  "examples/apps/chat-ui/template/AGENTS.md",
  "examples/apps/chat-ui/template/package.json",
  "examples/apps/chat-ui/template/public/nodeagent-chat-state.json",
  "examples/apps/chat-ui/template/scripts/run-chat-demo.mjs",
  "examples/apps/chat-ui/template/scripts/chat-ui-smoke.mjs",
  "examples/apps/chat-ui/template/src/nodeagent-chat/NodeAgentChatApp.jsx",
  "examples/apps/chat-ui/template/src/nodeagent-chat/nodeAgentLocalAdapter.js",
  "examples/apps/chat-ui/template/src/nodeagent-chat/toolUIs.jsx",
  "docs/CHAT_UI_ADOPTION.md",
  ...
  "scripts/nodeagent-chat-ui-scaffold-smoke.ts",
